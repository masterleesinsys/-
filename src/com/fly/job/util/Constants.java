...
public class Constants {
	...
	public static final String XML_MSG_FILE = "file";
	...
	static {
		APPID = PropertyCfg.getProperty("appid");
		SECRET = PropertyCfg.getProperty("secret");
		TOKEN = PropertyCfg.getProperty("token");
		AESKEY = PropertyCfg.getProperty("aeskey");
		DOMAIN_URL = PropertyCfg.getProperty("domain_url");
		System.out.println("[Init Constants]Constants>>>>>init Constants finished");
	}
