package com.wechat.mp.util.xml;

import com.thoughtworks.xstream.XStream;
import com.wechat.common.util.xml.XStreamInitializer;
import com.wechat.mp.bean.message.WxMpXmlMessage;
import com.wechat.mp.bean.message.WxMpXmlOutImageMessage;
import com.wechat.mp.bean.message.WxMpXmlOutMusicMessage;
import com.wechat.mp.bean.message.WxMpXmlOutNewsMessage;
import com.wechat.mp.bean.message.WxMpXmlOutTextMessage;
import com.wechat.mp.bean.message.WxMpXmlOutTransferKefuMessage;
import com.wechat.mp.bean.message.WxMpXmlOutVideoMessage;
import com.wechat.mp.bean.message.WxMpXmlOutVoiceMessage;
import com.wechat.mp.bean.message.*;
